...
<html lang="es">
    <head>
        ...
        <style>
            ...
            .detalle-compra-info {
                margin-top: 20px;
                margin-left: 50px; /* Ajusta el margen para centrar */
            ...
            .detalle-compra-productos {
                ...
                margin-top: 20px;
                margin-right: 50px; /* Ajusta el margen para centrar */
            }
            ...
            .btn-group button {
                margin-right: 30px; /* Ajusta el valor según el espaciado deseado */
            }
            .regresar-container{
                margin-left: 50px;
            }
    ...
    <body>
        ...
        <div class="regresar-container mt-3">
            <!-- Botón de regresar -->
            <a href="http://localhost:8080/AgroPiura/Controlador?accion=ListarComprasAdmin" class="btn btn-regresar">
        ...
        <div class="detalle-compra-container">
            ...
            <div class="detalle-compra-productos">
                ...
                <div class="botones">
                    ...
                    <form action="Controlador" method="post">
                        ...
                        <div class="btn-group" role="group" aria-label="Cambiar estado del pedido">
                            <button type="submit" name="nuevoEstado" value="1" class="btn btn-primary">Pago Verificado</button>
                            <button type="submit" name="nuevoEstado" value="2" class="btn btn-info">Preparando Pedido</button>
                            <button type="submit" name="nuevoEstado" value="3" class="btn btn-warning">Pedido Enviado</button>
                            <button type="submit" name="nuevoEstado" value="4" class="btn btn-success">Pedido Recibido</button>
                            <button type="submit" name="nuevoEstado" value="5" class="btn btn-danger">Pago Rechazado</button>
                        </div>
                    </form>
            ...
            <div class="comprobante">
                ...
                <img src="assets/comprobantes/${id_transaccion}.png" alt="Comprobante de pago" class="product-image" 
                     style="width: 300px; height: auto;"> <!-- Cambia el tamaño aquí -->
            </div>
        </div>
        <!-- Mensaje de alerta en la parte superior de la página -->
