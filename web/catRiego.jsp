                ...
                <div class="row justify-content-center">
                    <div class="col-md-3 custom-col">
                        <div class="image-container">
                            ...
                            <div class="item-text"><a href="Controlador?accion=FiltrarPorTipoProducto&tipoProducto=31" style="text-decoration: none; color: inherit;">ASPERSORES</a></div>
                        </div>
                    </div>
                    <div class="col-md-3 custom-col">
                        <div class="image-container">
                            <img src="assets/cat/tierra.png" alt="Tierra" class="img-fluid">
                            <div class="item-text"><a href="Controlador?accion=FiltrarPorTipoProducto&tipoProducto=32" style="text-decoration: none; color: inherit;">MANGUERAS</a></div>
                        </div>
                    </div>
